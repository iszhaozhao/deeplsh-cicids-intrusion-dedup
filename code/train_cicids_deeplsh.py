...
def _ensure_import_paths() -> None:
    ...
    python_packages = os.path.join(code_dir, "python-packages")
...
def _prepare_if_needed(args):
    from cicids_pipeline import prepare_cicids_dataset, prepared_paths
...
def main():
    ...
    parser.add_argument("--data-repo", default=None, help="Path to MachineLearningCVE directory")
    ...
    if args.data_repo is None:
        from cicids_pipeline import default_raw_data_dir
    ...
    models_dir = os.path.join(_project_root(), "code", "Models")
    hash_tables_dir = os.path.join(_project_root(), "code", "Hash-Tables")
